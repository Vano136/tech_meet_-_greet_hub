...
export const Location = MapPinIcon;
...
// Close Icon
export const CloseIcon: React.FC<IconProps> = ({ size = 20, color = "currentColor", ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const FireIcon: React.FC<SizedIconProps> = ({ size = 20, color = "currentColor", ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const VerifiedIcon: React.FC<SizedIconProps> = ({ size = 20, color = "currentColor", ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
